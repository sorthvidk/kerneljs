...
/***/ function(module, exports, __webpack_require__) {
	...
	var Boxes = function (_View) {
		_inherits(Boxes, _View);
		...
		function Boxes(settings) {
			...
			var _this = _possibleConstructorReturn(this, (Boxes.__proto__ || Object.getPrototypeOf(Boxes)).call(this, defaults));
	
			console.log(_this.displayName, _this);
			return _this;
		}
	...
	var Table = function (_View2) {
		...
		function Table(settings) {
			...
			//call the parent method with super
			var _this2 = _possibleConstructorReturn(this, (Table.__proto__ || Object.getPrototypeOf(Table)).call(this, defaults));
	
			console.log(_this2.displayName, _this2);
			return _this2;
		}
